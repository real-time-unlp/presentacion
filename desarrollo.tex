...
\begin{block}{}
	\begin{itemize}
		...
		\item Implementación no oficialmente soportada de FreeRTOS.%\href{https://github.com/feilipu/Arduino\_FreeRTOS\_Library}

		%\item Plaqueta Arduino UNO con el microcontrolador ATMEL
	\end{itemize}
\end{block}
\end{frame}
